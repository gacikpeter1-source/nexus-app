...
export default function EditEvent() {
  ...
  const [form, setForm] = useState({
    ...
    waitlistNotificationMode: 'one_by_one', // 🆕 NEW
    attachmentUrl: null,
    attachmentName: null
  });
  ...
  async function loadEvent() {
    try {
      ...
      setForm({
        ...
        date: eventData.date || '',
        time: eventData.time || '',
        startTime: eventData.startTime || eventData.time || '', // 🆕 NEW: Use startTime or fallback to time
        duration: eventData.duration || 60, // 🆕 NEW: Default to 60 minutes if not set
        endTime: eventData.endTime || '', // 🆕 NEW
        ...
        waitlistNotificationMode: eventData.waitlistNotificationMode || 'one_by_one', // 🆕 NEW
